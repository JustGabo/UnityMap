...
const Footer = ({authorLabel,createdAtLabel,disabled,isFavorite,onClick,title}: FooterProps) => {
  ...
  return (
    <div className='relative bg-white p-3'>
        ...
        <button onClick={handleClick} className={cn("opacity-0 group-hover:opacity-100 transition absolute top-3 right-3 text-muted-foreground hover:text-blue-600", disabled && "cursor-not-allowed opacity-75")} disabled={disabled}>
